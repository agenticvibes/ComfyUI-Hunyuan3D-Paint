...
class Hunyuan3DPaintConfig:
    def __init__(self, resolution, camera_azims, camera_elevs, view_weights, ortho_scale, texture_size, device="cuda",
                 paint_model_path=None, dino_model_path=None, realesrgan_model_path=None, mlx_weights_path=None):
        self.device = device
        ...
        self.paint_model_path = paint_model_path
        self.dino_ckpt_path = dino_model_path
        self.realesrgan_ckpt_path = realesrgan_model_path
        self.mlx_weights_path = mlx_weights_path
        self.diffusion_backend = "pytorch"
...
class Hunyuan3DPaintPipeline:
    ...
    def __call__(self, mesh, image_path=None, output_mesh_path=None, use_remesh=False, save_glb=True, num_steps=10, guidance_scale=3.0, unwrap=True, seed=0):
        ...
        diffusion_backend = getattr(self.config, 'diffusion_backend', 'pytorch')
        if diffusion_backend == "mlx":
            print("[MLX] MLX diffusion backend selected — UNet will run on Apple MLX")
        if self.model == None:
